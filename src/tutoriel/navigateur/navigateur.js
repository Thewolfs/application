...
Tutoriel_navigateur.start = function () {	
	...
	Tutoriel_navigateur.tutoLayer.children[1].innerText = Tutoriel_navigateur.text[language].quitTutoButton;
...
Tutoriel_navigateur.menu = function () {
	...
	Tutoriel_navigateur.changeText(Tutoriel_navigateur.text[language].menu, 700, 960, "middle");
...
Tutoriel_navigateur.choixMot = function () {
	...
	Tutoriel_navigateur.changeText("<tspan>" + Tutoriel_navigateur.text[language].choixMot.line1 + "</tspan><tspan x='200' dy='62'>" + Tutoriel_navigateur.text[language].choixMot.line2 + "</tspan>", 200, 200, "left");
...
Tutoriel_navigateur.transformation = function () {
	...
	Tutoriel_navigateur.changeText("<tspan>" + Tutoriel_navigateur.text[language].transformation.line1 + "</tspan><tspan x='800' dy='62'>" + Tutoriel_navigateur.text[language].transformation.line2 + "</tspan>", 650, 800, "left")
...
Tutoriel_navigateur.geste = function () {
	...
	Tutoriel_navigateur.changeText("<tspan>" + Tutoriel_navigateur.text[language].geste.line1 + "</tspan><tspan x='1000' dy='62'>" + Tutoriel_navigateur.text[language].geste.line2 + "</tspan>", 150, 1000,"left");
...
Tutoriel_navigateur.editeur = function () {
	setTimeout(function () {
		...
		Tutoriel_navigateur.changeText(Tutoriel_navigateur.text[language].editeur, 875, 900, "left");
...
Tutoriel_navigateur.addMot = function () {
	...
	Tutoriel_navigateur.changeText(Tutoriel_navigateur.text[language].addMot, 500, 200, "left");
}
...
Tutoriel_navigateur.chooseWordType = function () {
	...
	Tutoriel_navigateur.changeText(Tutoriel_navigateur.text[language].chooseWordType, 540, 960, "middle");
...
Tutoriel_navigateur.firstPoeme = function () {
	...
	Tutoriel_navigateur.changeText("<tspan>" + Tutoriel_navigateur.text[language].firstPoeme.line1 + "</tspan><tspan x='960' dy='65'>" + Tutoriel_navigateur.text[language].firstPoeme.line2 + "</tspan>", 540, 960, "middle");
}
...
Tutoriel_navigateur.endTuto = function () {
	...
	Tutoriel_navigateur.changeText("<tspan>" + Tutoriel_navigateur.text[language].endTuto.line1 + "</tspan><tspan x='960' dy='65'>" + Tutoriel_navigateur.text[language].endTuto.line2 + "</tspan><tspan x='960' dy='65'>" + Tutoriel_navigateur.text[language].endTuto.line3 + "</tspan>", 540, 960, "middle");
